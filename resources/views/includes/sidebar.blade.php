	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				@can('view-sales')
				<li class="submenu">
					<a href="#"><i class="fe fe-activity"></i> <span> Sales</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
						<li><a class="{{ Request::routeIs('purchases') ? 'active' : '' }}" href="{{route('orders')}}">Order</a></li>
						@can('total-sales')<li><a class="{{ Request::routeIs('purchases') ? 'active' : '' }}" href="{{route('sales')}}">Total Sales</a></li>@endcan
					</ul>
				</li>
				@endcan
